...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('recordCount').addEventListener('click', function recordCountHandler(e) {
...
const displayLastItemDialog = function (lastItem) {
    ...
    document.getElementById('showSalary').innerText = d3.format(',.0f')(lastItem.salary);
    dlg.dialog({
        buttons: {
            Ok: function () {
                $(this).dialog('close');
